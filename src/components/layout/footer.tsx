...
export function Footer() {
  ...
  return (
    <footer className="bg-[rgb(45,45,42)] text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10">
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-[rgb(180,178,172)] text-sm leading-relaxed mb-6">
              {t("footer.about")}
            </p>
          ...
          <div>
            <h3 className="font-semibold text-white mb-4 text-sm sm:text-base">{t("footer.quick_links")}</h3>
            <ul className="space-y-2 sm:space-y-3">
              {[
                ...
                <li key={link.to}>
                  <Link to={link.to} className="text-[rgb(180,178,172)] hover:text-[rgb(190,137,41)] transition-colors text-sm">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            <h3 className="font-semibold text-white mb-4 text-sm sm:text-base">{t("footer.legal")}</h3>
            <ul className="space-y-2 sm:space-y-3">
              <li>
                <a href="#" className="text-[rgb(180,178,172)] hover:text-[rgb(190,137,41)] transition-colors text-sm">
                  {t("footer.privacy")}
                </a>
              </li>
              <li>
        ...
        <div className="mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-[rgb(60,60,55)] text-center">
          ...
          <p className="text-[rgb(180,178,172)] text-xs sm:text-sm">
